...
// function stockLibrosData(data, generoLibro = ""){

//     let librosCargados = data

//     console.log(librosCargados)

//     if(generoLibro !== ""){
//         librosCargados = stockLibros.filter( libro => libro.genero === generoLibro)
//         console.log('ok' + librosCargados)
//     }
